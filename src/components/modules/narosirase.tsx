...
export default function Narosirase() {
  return (
    <Content>
      ...
      <Row space={16}>
        <Image orientation="portrait" src="/static/images/narosirase_1.jpg" alt="narosirase_1" />
        <Image orientation="portrait" src="/static/images/narosirase_2.jpg" alt="narosirase_2" />
      </Row>
    </Content>
  )
}
